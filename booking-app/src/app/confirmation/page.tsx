...
export default function ConfirmationPage() {
    ...
    // Use Paystack/Supabase reference from the success flow (no setState-in-effect)
    ...
    const confettiParticles = Array.from({ length: 50 }, (_, i) => {
        // Deterministic layout based on index
        const col = i % 10;
    ...
    const addToCalendar = () => {
        ...
        const event = {
            title: `Noir Hair Studios Appointment - ${selectedService.name}`,
            description: `Your appointment at Noir Hair Studios\\n\\nService: ${selectedService.name}${selectedAddons.length > 0 ? '\\nAdd-ons: ' + selectedAddons.map(a => a.name).join(', ') : ''}\\n\\nReference: ${bookingRef}`,
            location: 'Noir Hair Studios - Premium Grooming, Accra',
    ...
    const shareBooking = () => {
        const text = `I just booked my appointment at Noir Hair Studios! 💈\\n\\nService: ${selectedService.name}\\nDate: ${format(selectedDate, 'MMMM do, yyyy')}\\nTime: ${selectedTime}\\n\\nReference: ${bookingRef}`;

        if (navigator.share) {
            navigator.share({
                title: 'My Noir Hair Studios Appointment',
                text: text,
            ...
            <div className="relative z-10 container mx-auto px-6 py-12 max-w-4xl">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-start gap-4 pt-6 border-t border-white/10">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-white/60 text-sm">{selectedService.price} GHS • {selectedService.duration_minutes} min</p>
                            </div>
                        </div>
                ...
                >
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-white font-bold mb-2">Noir Hair Studios - Premium Grooming</h3>
                            <p className="text-white/60 text-sm mb-3">
                                123 Oxford Street, Osu, Accra<br />
                                Near Danquah Circle
                            </p>
                            <a
                                href="https://maps.google.com/?q=Noir+Hair+Studios+Accra"
                                target="_blank"
