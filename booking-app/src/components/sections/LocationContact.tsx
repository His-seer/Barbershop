                ...
                <div className="text-center mb-16">
                    ...
                    >
                        ...
                        <p className="text-white/60 max-w-2xl mx-auto text-lg">
                            Experience premium grooming in the heart of Accra
                        </p>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-white/50 text-sm mt-3">
                                        Landmark: Opposite Frankies Restaurant
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="bg-richblack-800/80 backdrop-blur-sm border border-white/10 rounded-2xl p-6 shadow-card">
                            ...
                            <div className="space-y-4">
                                ...
                                {/* Email */}
                                <a
                                    href="mailto:info@theshopgh.com"
                                    className="flex items-center gap-4 p-4 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 hover:border-gold-500/50 transition-all group"
                                >
                                    <div className="w-12 h-12 rounded-full bg-gold-500/10 flex items-center justify-center flex-shrink-0 group-hover:bg-gold-500/20 transition-colors">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-white font-semibold">info@theshopgh.com</p>
                                    </div>
                                </a>
                        ...
                        <div className="bg-richblack-800/80 backdrop-blur-sm border border-white/10 rounded-2xl p-6 shadow-card">
                            ...
                            <div className="space-y-3">
                                {operatingHours.map((schedule, index) => (
                                    <div
                                        key={index}
                                        className={`flex justify-between items-center py-2 ${index !== operatingHours.length - 1 ? 'border-b border-white/5' : ''}`}
                                    >
                                        <span className={`font-medium ${schedule.open ? 'text-white' : 'text-white/50'}`}>
                                            {schedule.day}
                                        </span>
                                        <span className={`font-mono text-sm ${schedule.open ? 'text-gold-400' : 'text-red-400'}`}>
                                            {schedule.hours}
                                        </span>
                                    </div>
                                ))}
                            ...
                            <div className="mt-6 pt-6 border-t border-white/10">
                                <div className="flex items-center justify-center gap-2 text-sm">
                                    ...
                                    <span className="text-white/70">Currently Open</span>
                                </div>
                            </div>
                        </div>
                    </motion.div>
